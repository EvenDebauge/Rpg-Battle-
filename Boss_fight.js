...
function shield (){
	if (Hp_perso1.value > 0){
		if (bouton_shield.disabled == false && Mana_perso1.value >= mana_shield){
			...
			textAction.innerHTML = "Le sort vous protège de la moitié des attaques du monstre. Vous avez consomé "+mana_shield+" points de Mana.";
...
function bossAtq (){
	if (Hp_boss.value <= 0 ){
		...
		Hp_perso1.innerHTML = Hp_perso1.value;
		textAction.innerHTML = "Le monstre vous inflige "+dmg_boss+" points de dégats";
	}
}
